document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach(card => {
        ...
        // Set second video URL from data attribute
        ...
        //removed div with matching id, to e used to unload twitch stream on collapse
        function removeTwitchEmbeds() {
            const container = document.getElementById('twitchStreamContainer');
            container.innerHTML = '';
        }
