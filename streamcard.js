document.addEventListener('DOMContentLoaded', function() {
    ...
    cards.forEach(card => {
        ...
        iframe1.src = `https://player.twitch.tv/?channel=${streamChannel1}&parent=www.midsouthfightclub.com&muted=true`;
        ...
        iframe2.src = `https://player.twitch.tv/?channel=${streamChannel2}&parent=www.midsouthfightclub.com&muted=true`;
